...
export default () => {
  ...
  const handleUpload = () => {
    ...
    reader.onload = async (event) => {
      ...
      try {
        ...
        const responseFormData = await axios.post(`${baseurl}/api/uploadtestimonal`, body, {
          headers: {
            Authorization: `${token}`,
  ...
  const handleDelete = (id) => {
    ...
    axios.delete(`${baseurl}/api/delete/testimonal/${id}`, {
      headers: {
        Authorization: `${token}`
      }
    })
  ...
  useEffect(() => {
    axios.get(`${baseurl}/api/get/testimonal`)
      .then(response => {
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      const response = await axios.put(`${baseurl}/api/update/testimonal/${editItemId}`, editData, {
        headers: {
          Authorization: `${token}`
        }
      });
